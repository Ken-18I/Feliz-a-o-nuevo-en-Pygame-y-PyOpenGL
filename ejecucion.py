...
class TexturedObjects(PyOGLApp):
    ...
    def __init__(self):
        super().__init__(450, 100, 840, 480)
        self.plane = None
        self.cube = None
        self.light = None
    ...
    def initialise(self):
        ...
        self.botella = LoadMesh("objetos/botella.obj", "images/textura-botella.png", self.program_id,
                              location=pygame.Vector3(-4, 0, 0),
                              move_rotation=Rotation(1,pygame.Vector3(-1,0,0)),
                              scale=pygame.Vector3(1.5,1.5,1.5)
                              )
        self.copa = LoadMesh("objetos/copa.obj", "images/textura-copa.png", self.program_id,
                              location=pygame.Vector3(4, 0, 0),
                              move_rotation=Rotation(1,pygame.Vector3(1,0,0)),
                              scale=pygame.Vector3(0.2,0.2,0.2)
                              )
        self.globos = LoadMesh("objetos/globos.obj", "images/textura-globos.png", self.program_id,
                              location=pygame.Vector3(0, 0.4, 0),
                              move_rotation=Rotation(1,pygame.Vector3(0,-1,0))
                              )
        self.letras = LoadMesh("objetos/letras.obj", "images/textura-letras.png", self.program_id,
                              location=pygame.Vector3(0, -1.5, 0),
                              #scale=pygame.Vector3(10,10,10),
                              move_rotation=Rotation(1,pygame.Vector3(0,1,0))
                              )
        self.light = Light(self.program_id, pygame.Vector3(0, 10, 10), pygame.Vector3(1, 1, 1), 2)
        self.light2 = Light(self.program_id, pygame.Vector3(0, -10, -10), pygame.Vector3(1, 1, 1), 1)
